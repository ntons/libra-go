...
func (x *UserAdminBindAcctIdResponse) Reset() {
	*x = UserAdminBindAcctIdResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_libra_v1_user_admin_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserAdminBindAcctIdResponse) Descriptor() ([]byte, []int) {
	return file_libra_v1_user_admin_proto_rawDescGZIP(), []int{10}
}
...
func (x *UserAdminGetRequest_Options) Reset() {
	*x = UserAdminGetRequest_Options{}
	if protoimpl.UnsafeEnabled {
		mi := &file_libra_v1_user_admin_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_libra_v1_user_admin_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x6c, 0x65, 0x73, 0x22, 0x4e, 0x0a, 0x0c, 0x55, 0x73, 0x65, 0x72, 0x42, 0x61, 0x6e,
	0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x15, 0x0a, 0x06, 0x62, 0x61, 0x6e, 0x5f, 0x74, 0x6f, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x62, 0x61, 0x6e, 0x54, 0x6f, 0x12, 0x17, 0x0a, 0x07,
	0x62, 0x61, 0x6e, 0x5f, 0x66, 0x6f, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x62,
	0x61, 0x6e, 0x46, 0x6f, 0x72, 0x22, 0x62, 0x0a, 0x13, 0x55, 0x73, 0x65, 0x72, 0x41, 0x64, 0x6d,
...
var file_libra_v1_user_admin_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
...
func file_libra_v1_user_admin_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_libra_v1_user_admin_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_libra_v1_user_admin_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
