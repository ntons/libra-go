...
type UserAdminTransAcctIdRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	TargetUserId string `protobuf:"bytes,1,opt,name=target_user_id,json=targetUserId,proto3" json:"target_user_id,omitempty"` // 转移到目标用户
	AcctId       string `protobuf:"bytes,2,opt,name=acct_id,json=acctId,proto3" json:"acct_id,omitempty"`                     // 要转移的账号
}

func (x *UserAdminTransAcctIdRequest) Reset() {
	*x = UserAdminTransAcctIdRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *UserAdminTransAcctIdRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserAdminTransAcctIdRequest) ProtoMessage() {}

func (x *UserAdminTransAcctIdRequest) ProtoReflect() protoreflect.Message {
	mi := &file_libra_v1_useradmin_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserAdminTransAcctIdRequest.ProtoReflect.Descriptor instead.
func (*UserAdminTransAcctIdRequest) Descriptor() ([]byte, []int) {
	return file_libra_v1_useradmin_proto_rawDescGZIP(), []int{9}
}

func (x *UserAdminTransAcctIdRequest) GetTargetUserId() string {
	if x != nil {
...
func (x *UserAdminTransAcctIdRequest) GetAcctId() string {
	if x != nil {
		return x.AcctId
	}
	return ""
...
type UserAdminTransAcctIdResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *UserAdminTransAcctIdResponse) Reset() {
	*x = UserAdminTransAcctIdResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *UserAdminTransAcctIdResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserAdminTransAcctIdResponse) ProtoMessage() {}

func (x *UserAdminTransAcctIdResponse) ProtoReflect() protoreflect.Message {
	mi := &file_libra_v1_useradmin_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserAdminTransAcctIdResponse.ProtoReflect.Descriptor instead.
func (*UserAdminTransAcctIdResponse) Descriptor() ([]byte, []int) {
...
var file_libra_v1_useradmin_proto_rawDesc = []byte{
	...
	0x22, 0x5c, 0x0a, 0x1b, 0x55, 0x73, 0x65, 0x72, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x54, 0x72, 0x61,
	0x6e, 0x73, 0x41, 0x63, 0x63, 0x74, 0x49, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	...
	,
	...
	,
...
var file_libra_v1_useradmin_proto_goTypes = []interface{}{
	...
	(*UserAdminTransAcctIdRequest)(nil),  // 9: libra.v1.UserAdminTransAcctIdRequest
	(*UserAdminTransAcctIdResponse)(nil), // 10: libra.v1.UserAdminTransAcctIdResponse
...
var file_libra_v1_useradmin_proto_depIdxs = []int32{
	...
	9,  // 8: libra.v1.UserAdmin.TransAcctId:input_type -> libra.v1.UserAdminTransAcctIdRequest
	...
	10, // 13: libra.v1.UserAdmin.TransAcctId:output_type -> libra.v1.UserAdminTransAcctIdResponse
...
func file_libra_v1_useradmin_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_libra_v1_useradmin_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UserAdminTransAcctIdRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_libra_v1_useradmin_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UserAdminTransAcctIdResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
