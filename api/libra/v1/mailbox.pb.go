...
type MailboxPullRequest struct {
	...
	Options *MailboxPullRequest_Options `protobuf:"bytes,10,opt,name=options,proto3" json:"options,omitempty"`
}
...
func (x *MailboxPullRequest) GetOptions() *MailboxPullRequest_Options {
	if x != nil {
		return x.Options
	}
	return nil
...
type MailboxPullRequest_Options struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *MailboxPullRequest_Options) Reset() {
	*x = MailboxPullRequest_Options{}
	if protoimpl.UnsafeEnabled {
...
func (x *MailboxPullRequest_Options) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MailboxPullRequest_Options) ProtoMessage() {}

func (x *MailboxPullRequest_Options) ProtoReflect() protoreflect.Message {
	mi := &file_libra_v1_mailbox_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MailboxPullRequest_Options.ProtoReflect.Descriptor instead.
func (*MailboxPullRequest_Options) Descriptor() ([]byte, []int) {
	return file_libra_v1_mailbox_proto_rawDescGZIP(), []int{5, 0}
}

func (x *MailboxPullRequest_Options) GetRegardNotFoundAsEmpty() bool {
	if x != nil {
...
var file_libra_v1_mailbox_proto_rawDesc = []byte{
	...
	0x12, 0x4d, 0x61, 0x69, 0x6c, 0x62, 0x6f, 0x78, 0x50, 0x75, 0x6c, 0x6c, 0x52, 0x65, 0x71, 0x75,
	...
	,
...
var file_libra_v1_mailbox_proto_goTypes = []interface{}{
	...
	(*MailboxPullRequest_Options)(nil), // 7: libra.v1.MailboxPullRequest.Options
...
var file_libra_v1_mailbox_proto_depIdxs = []int32{
	...
	9,  // 3: libra.v1.MailboxPushRequest.key:type_name -> libra.v1.EntryKey
	8,  // 4: libra.v1.MailboxPushRequest.data:type_name -> google.protobuf.Any
	9,  // 5: libra.v1.MailboxPullRequest.key:type_name -> libra.v1.EntryKey
	7,  // 6: libra.v1.MailboxPullRequest.options:type_name -> libra.v1.MailboxPullRequest.Options
...
func file_libra_v1_mailbox_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_libra_v1_mailbox_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MailboxPullRequest_Options); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
