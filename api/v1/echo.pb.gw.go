...
func request_Echo_Repeat_0(ctx context.Context, marshaler runtime.Marshaler, client EchoClient, req *http.Request, pathParams map[string]string) (Echo_RepeatClient, runtime.ServerMetadata, error) {
	var protoReq EchoRepeatRequest
	var metadata runtime.ServerMetadata
	...
	stream, err := client.Repeat(ctx, &protoReq)
	if err != nil {
...
func RegisterEchoHandlerServer(ctx context.Context, mux *runtime.ServeMux, server EchoServer) error {
	...
	mux.Handle("POST", pattern_Echo_Repeat_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterEchoHandlerClient(ctx context.Context, mux *runtime.ServeMux, client EchoClient) error {
	...
	mux.Handle("POST", pattern_Echo_Repeat_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Echo_Repeat_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Echo_Repeat_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Echo_Echo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1}, []string{"v1", "echo"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Echo_Repeat_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "echo", "repeat"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_Echo_Echo_0 = runtime.ForwardResponseMessage

	forward_Echo_Repeat_0 = runtime.ForwardResponseStream
)
