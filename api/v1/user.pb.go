...
// State features affect behavior
type LoginStateFeatures struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Create user if not found
	CreateUserIfNotFound bool `protobuf:"varint,1,opt,name=create_user_if_not_found,json=createUserIfNotFound,proto3" json:"create_user_if_not_found,omitempty"`
	// Take over acct_id if duplicated
...
func (x *LoginStateFeatures) Reset() {
	*x = LoginStateFeatures{}
	if protoimpl.UnsafeEnabled {
...
func (x *LoginStateFeatures) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoginStateFeatures) ProtoMessage() {}

func (x *LoginStateFeatures) ProtoReflect() protoreflect.Message {
	mi := &file_v1_user_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoginStateFeatures.ProtoReflect.Descriptor instead.
func (*LoginStateFeatures) Descriptor() ([]byte, []int) {
	return file_v1_user_proto_rawDescGZIP(), []int{13}
}

func (x *LoginStateFeatures) GetCreateUserIfNotFound() bool {
	if x != nil {
		return x.CreateUserIfNotFound
	}
	return false
}

func (x *LoginStateFeatures) GetTakeOverAcctIdIfDuplicated() bool {
	if x != nil {
...
type UniformLoginState struct {
	...
	// features
	Features *LoginStateFeatures `protobuf:"bytes,10,opt,name=features,proto3" json:"features,omitempty"`
...
func (x *UniformLoginState) GetFeatures() *LoginStateFeatures {
	if x != nil {
		return x.Features
	}
	return nil
...
var file_v1_user_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x55, 0x0a, 0x10, 0x55, 0x73, 0x65, 0x72, 0x4c,
	0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x15, 0x0a, 0x06, 0x61,
	...
	0x62, 0x75, 0x66, 0x2e, 0x41, 0x6e, 0x79, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0x3b,
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x91, 0x01, 0x0a, 0x12, 0x4c, 0x6f, 0x67,
	0x69, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73, 0x12,
	0x36, 0x0a, 0x18, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69,
	0x66, 0x5f, 0x6e, 0x6f, 0x74, 0x5f, 0x66, 0x6f, 0x75, 0x6e, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x14, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x49, 0x66, 0x4e,
	0x6f, 0x74, 0x46, 0x6f, 0x75, 0x6e, 0x64, 0x12, 0x43, 0x0a, 0x1f, 0x74, 0x61, 0x6b, 0x65, 0x5f,
	...
	0x49, 0x66, 0x44, 0x75, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x65, 0x64, 0x22, 0xd3, 0x01, 0x0a,
	...
	0x75, 0x73, 0x65, 0x72, 0x49, 0x70, 0x12, 0x38, 0x0a, 0x08, 0x66, 0x65, 0x61, 0x74, 0x75, 0x72,
	0x65, 0x73, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x6c, 0x69, 0x62, 0x72, 0x61,
	0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x46, 0x65,
	...
	0x0a, 0x05, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6e,
	...
	0x72, 0x65, 0x32, 0xb9, 0x03, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x40, 0x0a, 0x05, 0x4c,
	...
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x22,
...
var file_v1_user_proto_goTypes = []interface{}{
	...
	(*LoginStateFeatures)(nil),      // 13: libra.v1.LoginStateFeatures
...
var file_v1_user_proto_depIdxs = []int32{
	...
	18, // 1: libra.v1.UserLoginRequest.state:type_name -> google.protobuf.Any
	0,  // 2: libra.v1.UserLoginResponse.user:type_name -> libra.v1.UserData
	18, // 3: libra.v1.UserBindRequest.state:type_name -> google.protobuf.Any
	...
	13, // 6: libra.v1.UniformLoginState.features:type_name -> libra.v1.LoginStateFeatures
	1,  // 7: libra.v1.User.Login:input_type -> libra.v1.UserLoginRequest
	3,  // 8: libra.v1.User.Logout:input_type -> libra.v1.UserLogoutRequest
	5,  // 9: libra.v1.User.Bind:input_type -> libra.v1.UserBindRequest
	7,  // 10: libra.v1.User.Unbind:input_type -> libra.v1.UserUnbindRequest
	9,  // 11: libra.v1.User.SetMetadata:input_type -> libra.v1.UserSetMetadataRequest
	11, // 12: libra.v1.User.GetMetadata:input_type -> libra.v1.UserGetMetadataRequest
	2,  // 13: libra.v1.User.Login:output_type -> libra.v1.UserLoginResponse
	4,  // 14: libra.v1.User.Logout:output_type -> libra.v1.UserLogoutResponse
	6,  // 15: libra.v1.User.Bind:output_type -> libra.v1.UserBindResponse
	8,  // 16: libra.v1.User.Unbind:output_type -> libra.v1.UserUnbindResponse
	10, // 17: libra.v1.User.SetMetadata:output_type -> libra.v1.UserSetMetadataResponse
	12, // 18: libra.v1.User.GetMetadata:output_type -> libra.v1.UserGetMetadataResponse
...
func file_v1_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_v1_user_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LoginStateFeatures); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
