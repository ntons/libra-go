...
func (x *SyncLockRequest) GetAppId() string {
	if x != nil {
		return x.AppId
	}
	return ""
...
func (x *SyncLockRequest) GetCollection() string {
	if x != nil {
		return x.Collection
	}
	return ""
...
func (x *SyncLockRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_v1_sync_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x11, 0x0a, 0x0f, 0x53, 0x79, 0x6e, 0x63, 0x4c, 0x6f,
	0x63, 0x6b, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x3b, 0x0a, 0x11, 0x53, 0x79, 0x6e,
	0x63, 0x55, 0x6e, 0x6c, 0x6f, 0x63, 0x6b, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x26,
	...
	0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x22, 0x96, 0x01, 0x0a, 0x0f, 0x53, 0x79, 0x6e, 0x63, 0x4c,
	0x6f, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x15, 0x0a, 0x06, 0x61, 0x70,
...
var file_v1_sync_proto_depIdxs = []int32{
	0, // 0: libra.v1.SyncLockRequest.lock_options:type_name -> libra.v1.SyncLockOptions
	6, // 1: libra.v1.SyncLockResponse.lock:type_name -> google.protobuf.Any
	6, // 2: libra.v1.SyncUnlockRequest.lock:type_name -> google.protobuf.Any
	1, // 3: libra.v1.SyncUnlockRequest.unlock_options:type_name -> libra.v1.SyncUnlockOptions
	2, // 4: libra.v1.Sync.Lock:input_type -> libra.v1.SyncLockRequest
	4, // 5: libra.v1.Sync.Unlock:input_type -> libra.v1.SyncUnlockRequest
	3, // 6: libra.v1.Sync.Lock:output_type -> libra.v1.SyncLockResponse
	5, // 7: libra.v1.Sync.Unlock:output_type -> libra.v1.SyncUnlockResponse
